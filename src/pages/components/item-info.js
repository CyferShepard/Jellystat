  ...
  return (
    <div>
      <div className="item-detail-container rounded-3" style={cardStyle}>
        <Row
          className="justify-content-center justify-content-md-start rounded-3 g-0 p-4"
          style={cardBgStyle}
        >
          <Col className="col-auto my-4 my-md-0 item-banner-image">
            {data.PrimaryImageHash &&
            data.PrimaryImageHash != null &&
            !loaded ? (
              <Blurhash
            ...
            <div className="item-details">
              ...
              <div className="my-3">
                {data.Type === "Episode" ? (
                  <p>
                    <Link
                      to={`/libraries/item/${data.SeasonId}`}
                      className="fw-bold"
                    >
                      {data.SeasonName}
                    </Link>{" "}
                    Episode {data.IndexNumber} - {data.Name}
                  </p>
                ) : (
                  <></>
                )}
                ...
                {data.RunTimeTicks ? (
                  <p style={{ color: "lightgrey" }} className="fst-italic fs-6">
                    {data.Type === "Series" ? "Average Runtime" : "Runtime"}:{" "}
