...
function MoreItemCards(props) {
  ...
  return (
    <div
      className={
        props.data.Type === "Episode" ? "last-card episode-card" : "last-card"
      }
    >
      <Link
        to={`/libraries/item/${
      ...
      >
        ...
        >
          {((props.data.ImageBlurHashes &&
            props.data.ImageBlurHashes != null) ||
            (props.data.PrimaryImageHash &&
              props.data.PrimaryImageHash != null)) &&
          !loaded ? (
            <Blurhash
              hash={
                props.data.PrimaryImageHash ||
                props.data.ImageBlurHashes.Primary[props.data.ImageTags.Primary]
              }
              width={"100%"}
              height={"100%"}
      ...
      <div className="last-item-details">
        ...
        {props.data.Type === "Episode" ? (
          <div className="last-item-name">
            {" "}
            S{props.data.ParentIndexNumber || 0} - E
            {props.data.IndexNumber || 0}
          </div>
        ) : (
          <></>
        )}
