  ...
  return (
    <React.Fragment>
      <TableRow sx={{ "& > *": { borderBottom: "unset" } }}>
        <TableCell>
          {data.PrimaryImageTag ? (
            <img
              ...
              src={
                "Proxy/Users/Images/Primary?id=" + data.UserId + "&quality=10"
              }
              alt=""
            />
          ) : (
        ...
        <TableCell>
          <Link
            to={`/libraries/item/${data.NowPlayingItemId}`}
        ...
        <TableCell>
          {formatTotalWatchTime(data.TotalWatchTime) || "0 minutes"}
        </TableCell>
        <TableCell>
          {data.LastSeen ? formatLastSeenTime(data.LastSeen) : "never"}
        </TableCell>
      </TableRow>
    </React.Fragment>
  );
