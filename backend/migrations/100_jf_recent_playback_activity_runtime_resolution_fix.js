...
AS $BODY$
      BEGIN
          ...
          WITH rankedactivities AS (
               SELECT COALESCE(NULLIF(e."RunTimeTicks", 0), NULLIF(i."RunTimeTicks", 0)) AS "RunTimeTicks",
			   CASE
      			WHEN COALESCE(NULLIF(e."RunTimeTicks", 0)::numeric(100,0), NULLIF(i."RunTimeTicks", 0)::numeric(100,0), 1.0) > 0 THEN ((a."PlaybackDuration" * 10000000)::numeric(100,0) / COALESCE(NULLIF(e."RunTimeTicks", 0)::numeric(100,0), NULLIF(i."RunTimeTicks", 0)::numeric(100,0), 1.0) * 100::numeric)::numeric(100,2)
      		   ELSE 1.0
    		   END AS "Progress",
                  a."Id",
                  a."IsPaused",
