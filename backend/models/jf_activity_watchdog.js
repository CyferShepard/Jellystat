...
const jf_activity_watchdog_mapping = (item) => ({
  Id: item.Id,
  IsPaused:
    item.PlayState.IsPaused !== undefined
      ? item.PlayState.IsPaused
      : item.IsPaused,
  UserId: item.UserId,
